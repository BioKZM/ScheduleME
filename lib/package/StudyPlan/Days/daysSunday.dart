...
class daysSunday extends StatefulWidget {
  const daysSunday({Key? key}) : super(key: key);

  @override
  State<daysSunday> createState() => _daysSundayState();
}

class _daysSundayState extends State<daysSunday> {
