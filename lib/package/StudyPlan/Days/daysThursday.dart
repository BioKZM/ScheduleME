...
class daysThursday extends StatefulWidget {
  const daysThursday({Key? key}) : super(key: key);

  @override
  State<daysThursday> createState() => _daysThursdayState();
}

class _daysThursdayState extends State<daysThursday> {
