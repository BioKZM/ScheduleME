...
class daysTuesday extends StatefulWidget {
  const daysTuesday({Key? key}) : super(key: key);

  @override
  State<daysTuesday> createState() => _daysTuesdayState();
}

class _daysTuesdayState extends State<daysTuesday> {
